...
namespace CarRentalApp
{
    public partial class ManageVehicleListing : Form
    {
        ...
        //New Function to PopulationGrid. Can be called anytime we need a grid fefresh
        public void PopulateGrid()
        {
            ...
            //Hide the columm for ID. Changed from the hard coded column value to the name,
